...
class Ui_Snakemake(object):
    def setupUi(self, Snakemake):
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(20, 10, 331, 192))
        ...
        self.layout_general.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.snakemake_options_general_no__hooks_value)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.layout_general.setItem(8, QtWidgets.QFormLayout.FieldRole, spacerItem2)
        ...
        self.layout_general.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.snakemake_options_general_custom)
        self.label = QtWidgets.QLabel(self.formLayoutWidget_3)
        self.label.setObjectName("label")
        self.layout_general.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label)
        ...
        self.layout_general.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.snakemake_options_general_verbose_value)
        ...
        self.layout_general.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.snakemake_options_general_summary_value)
        ...
        self.layout_general.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.snakemake_options_general_keep__going_value)
    ...
    def retranslateUi(self, Snakemake):
        ...
        self.snakemake_options_cluster_config_label.setToolTip(_translate("Snakemake", "<html><head/><body><p>Name of the cluster config file to be found in the working directory.</p><p><br/></p><p>Sequana pipeline selection will automatically fill the name (cluster_config.json)</p><p><br/></p><p>If set, snakemake is ran with the parameter --cluster-config </p></body></html>"))
        ...
        self.snakemake_options_general_keep__going_value.setToolTip(_translate("Snakemake", "<html><head/><body><p>Go on with independent jobs if a job fails.</p></body></html>"))
