...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabs_pipeline.setMinimumSize(QtCore.QSize(0, 151))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 654, 181))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Please, Check the snakemake dialog (<b>Ctrl+O</b>) to set the number of nodes in the local or cluster tabs"))
