...
class GenomeCov(object):
    ...
    def genbank_filename(self, genbank_filename):
        """ Set the genbank file to annotate ROI detected with 
        :meth:`ChromosomeCov.get_roi`.

        :param: str genbank_filename: genbank file name.
        """
    ...
    def feature_dict(self):
        """ Return features dictionary of the genbank.
        """
    ...
    def feature_dict(self, anything):
        logger.error("AttributeError: You can't set attribute.\nfeature_dict "
                     "attribute is set when genbank_filename is set.")
        sys.exit(1)
